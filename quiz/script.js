const questions = [
    { question: "Listen to the sounds: /p/ and /b/. Select the one that starts the word 'pat.'", audio: "p_sound.mp3", options: ['p', 'b', 'd', 'g', 't'], correct: ['p'] },
    ...
    { question: "Listen: /t/ and /d/. Which sound starts the word 'dog'?", audio: "d_sound.mp3", options: ['t', 'd', 'g', 's', 'p'], correct: ['d'] },
    ...
    { question: "Which word starts with the /f/ sound?", audio: "fa_sound.mp3", options: ['fan', 'pan', 'can', 'man', 'ran'], correct: ['fan'] },
    ...
    { question: "Choose the correct sound for the word 'train.'", audio: "tr_sound.mp3", options: ['t', 'd', 'k', 'b', 's'], correct: ['t'] },
    { question: "Listen: /h/ and /k/. Which sound starts the word 'hat'?", audio: "h_sound.mp3", options: ['h', 'k', 'g', 'd', 's'], correct: ['h'] },
    ...
    { question: "Which word starts with the /y/ sound?", audio: "ye_sound.mp3", options: ['yellow', 'hello', 'fellow', 'mellow', 'bellow'], correct: ['yellow'] },
